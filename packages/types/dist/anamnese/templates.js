...
exports.ANAMNESE_TEMPLATES = void 0;
exports.getSecoesByEspecialidade = getSecoesByEspecialidade;
exports.getQuestoesBySecao = getQuestoesBySecao;
// ──────────────────────────────────────────────────────────────────
// ODONTOLOGIA
// ──────────────────────────────────────────────────────────────────
const questoesOdontologia = [
    // ── Dados Gerais ───────────────────────────────────────────────
    {
        id: 'motivo_consulta',
        secao: 'Dados Gerais',
...
function getSecoesByEspecialidade(especialidade) {
    const questoes = exports.ANAMNESE_TEMPLATES[especialidade] ?? questoesGeral;
    return [...new Set(questoes.map((q) => q.secao))];
}
/** Returns questions for a specific section */
function getQuestoesBySecao(especialidade, secao) {
    return (exports.ANAMNESE_TEMPLATES[especialidade] ?? questoesGeral).filter((q) => q.secao === secao);
}
