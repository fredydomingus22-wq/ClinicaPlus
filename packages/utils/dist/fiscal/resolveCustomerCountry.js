...
exports.resolveCustomerCountry = resolveCustomerCountry;
/**
 ...
 */
function resolveCustomerCountry(nif, explicit) {
    const trimmed = explicit?.trim();
    if (trimmed) {
        return trimmed.toUpperCase().slice(0, 2);
    }
    const fallback = (typeof process !== 'undefined' && process.env?.AGT_DEFAULT_CUSTOMER_COUNTRY) || 'AO';
    if (!nif)
        return fallback;
...
//# sourceMappingURL=resolveCustomerCountry.js.map