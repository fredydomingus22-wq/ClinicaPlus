import { formatGreeting } from './contactResolver';
...
export function appointmentReminderTemplate(data: AppointmentReminderData): string {
  const greeting = formatGreeting(data.patientName);
 ...
 */
export function treatmentUpdateTemplate(data: TreatmentNotificationData): string {
  const greeting = formatGreeting(data.patientName);
 ...
 */
export function treatmentSessionTemplate(data: TreatmentNotificationData): string {
  const greeting = formatGreeting(data.patientName);
 ...
 */
export function paymentConfirmationTemplate(data: PaymentReminderData): string {
  const greeting = formatGreeting(data.patientName);
