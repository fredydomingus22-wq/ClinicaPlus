...
exports.ESTADO_CONFIG = void 0;
exports.StatusBadge = StatusBadge;
const jsx_runtime_1 = require("react/jsx-runtime");
exports.ESTADO_CONFIG = {
...
function StatusBadge({ estado, className = '' }) {
    const config = exports.ESTADO_CONFIG[estado];
    if (!config)
        return null;
    return ((0, jsx_runtime_1.jsxs)("span", { className: `
      ...
      ${config.styles}
      ${className}
    `, children: [(0, jsx_runtime_1.jsx)("span", { className: `h-1.5 w-1.5 ${config.dot}`, "aria-hidden": "true" }), config.label] }));
}
