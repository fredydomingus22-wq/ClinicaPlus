...
// Adicionar a relação na model Paciente
...
if (!schema.includes('enum WaEstadoInstancia')) {
  fs.writeFileSync(schemaPath, schema + '\\n' + waModels, 'utf8');
  console.log('Modelos adicionados com sucesso.');
} else {
  console.log('Modelos já presentes.');
}
