...
exports.withFiscalImmutability = withFiscalImmutability;
 ...
 */
function withFiscalImmutability(prismaClient) {
            ...
            if (params.action === "delete" || params.action === "deleteMany") {
                if (params.args?.where?.id) {
                    ...
                    if (fatura && fatura.estado !== "RASCUNHO") {
                        throw new AppError_1.AppError('Documento fiscal emitido é imutável. Use Nota de Crédito para anular.', 403, 'FISCAL_IMMUTABILITY');
                    }
                }
            }
