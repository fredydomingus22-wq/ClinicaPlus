    ...
    <div style="${BASE_STYLE}">
      ...
      <div style="padding: 40px; background: white; border-left: 1px solid #e2e8f0; border-right: 1px solid #e2e8f0;">
        ...
        <div style="background: #eff6ff; border-left: 4px solid #3b82f6; padding: 20px; margin: 24px 0; border-radius: 4px;">
          <p style="margin: 0 0 10px;"><strong>Data e Hora:</strong> ${(0, utils_1.formatDateTime)(data.dataHora)}</p>
  ...
  `,
    ...
    <div style="${BASE_STYLE}">
      ...
      <div style="padding: 40px; background: white; border-left: 1px solid #e2e8f0; border-right: 1px solid #e2e8f0;">
        ...
        <p>Olá,</p>
        <p>A subscrição da clínica <strong>${data.clinicaNome}</strong> termina em <strong>${data.diasRestantes} dias</strong> (${(0, utils_1.formatDateTime)(data.dataExpiracao)}).</p>
  ...
  `,
    ...
    <div style="${BASE_STYLE}">
      ...
      <div style="padding: 40px; background: white; border-left: 1px solid #e2e8f0; border-right: 1px solid #e2e8f0;">
        ...
        <p>Olá,</p>
        <p>Informamos que a subscrição da clínica <strong>${data.clinicaNome}</strong> expirou em ${(0, utils_1.formatDateTime)(data.dataExpiracao)}.</p>
